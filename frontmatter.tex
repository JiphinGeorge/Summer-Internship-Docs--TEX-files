...
The culmination of this internship was the capstone project: ``QualiVision AI – Industrial Quality Control System.'' Designed to automate quality inspection in food processing industries, the system leverages a convolutional neural network (EfficientNetV2B0) to classify agricultural produce as fresh or rotten. It features real-time prediction capabilities, a robust Flask backend, an SQLite database for persistent logging, and a professional industrial dashboard created using Google Stitch. Furthermore, Gradient-weighted Class Activation Mapping (Grad-CAM) was implemented to provide Explainable AI (XAI) insights, ensuring transparency in the model's decision-making process.
