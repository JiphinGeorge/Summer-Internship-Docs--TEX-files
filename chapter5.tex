...
\begin{itemize}[leftmargin=1.5cm]
    ...
    \item \textbf{Time Management:} Balancing multiple mini-projects and strict deadlines leading up to the final capstone project significantly improved my ability to manage time efficiently and prioritize tasks.
    ...
    \item \textbf{Professional Ethics:} Operating in a structured corporate environment instilled a strong sense of professional ethics, accountability, and disciplined work habits.
\end{itemize}
