...
\section{Week 1: Introduction to AI and Projects}
...
\textbf{Learning Outcome:} The project provided practical exposure to handling text data and illustrated how projects serve as building blocks for understanding complete AI workflows.
...
\textbf{Learning Outcome:} The project provided a complete walkthrough of the standard ML pipeline, from loading data to evaluating the model.
